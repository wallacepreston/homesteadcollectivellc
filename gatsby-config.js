  ...
  plugins: [
    'gatsby-plugin-sitemap',
    {
      ...
      options: {
        ...
        trackingIds: [
          "G-LR974MMZ9S", // Google Analytics / GA Tag (sends data to Google Analytics)
          "10119894585", // Google Analytics / Measurement ID or Stream ID (identifies this site in Google Analytics)
        ],
